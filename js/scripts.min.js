...
/*!
 * Generated using the Bootstrap Customizer (https://getbootstrap.com/docs/3.3/customize/?id=940e5da5f0c82f715e154137546084ee)
 * Config saved to config.json and https://gist.github.com/940e5da5f0c82f715e154137546084ee
 */
...
$(function(){$(".make-appointment").click(function(){$("#myModal").modal()}),$("#date").dateDropdowns({dropdownClass:"form-control",wrapperClass:"col-sm-7",defaultDate:(new Date).toISOString().slice(0,10),minYear:"2017",maxYear:"2018",monthLongValues:["Январь","Февраль","Март","Апрель","Май","Июнь","Июль","Август","Сентябрь","Октябрь","Ноябрь","Декабрь"],daySuffixes:!1,defaultDateFormat:"yyyy-mm-dd",dayLabel:"",monthLabel:"",yearLabel:""})});